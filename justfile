...
# send integrated preconfirmation test scenario with account funding, exclusions, and first inclusion
send-preconfs-test-scenario count='1':
    #!/usr/bin/env bash
    set -euo pipefail
    ...
    echo "🏦 Funding test accounts before running preconfirmation scenario..."
